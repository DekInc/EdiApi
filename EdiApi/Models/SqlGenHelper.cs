...
namespace EdiApi.Models {
    public static class SqlGenHelper {
        ...
        public static string DBName = "wms_test";
        public static string GetSqlWmsMaxTbl(string TableName, string Pk, string Var) {
            return $"SELECT @{Var} = ISNULL(MAX({Pk}), 0) + 1 FROM {DBName}.dbo.{TableName}; {Temp}";
        }
        public static string GetSqlWmsInsertTransacciones(Transacciones T) {
            return $"INSERT INTO {DBName}.dbo.Transacciones(TransaccionID, NoTransaccion, IDTipoTransaccion, FechaTransaccion, BodegaID, RegimenID, ClienteID, TipoIngreso, Observacion, Usuariocrea, Fechacrea, EstatusID, exportadorid, destinoid) " +
        ...
        public static string GetSqlWmsInsertProducto(Producto P) {
            return $"INSERT INTO {DBName}.dbo.Producto(CodProducto, Descripcion, UnidadMedida, ClienteID, EstatusID, CategoriaID, CantMinima, Fecha, Comentario, stock_maximo, descargoid, partida) " +
        ...
        public static string GetSqlWmsInsertInventario(Inventario I) {
            return $"INSERT INTO {DBName}.dbo.Inventario(InventarioID, Barcode, FechaCreacion, ClienteID, Descripcion, Declarado, Valor, Articulos, Peso, Volumen, EstatusID, IsAgranel, TipoBulto, existencia, auditado, cantidadinicial, Rack)"
        ...
        public static string GetSqlWmsInsertDetalleTransacciones(DetalleTransacciones DT) {
            return $"INSERT INTO {DBName}.dbo.DetalleTransacciones(DtllTrnsaccionID, TransaccionID, InventarioID, Conteo, Cantidad, Valor, fechaitem, rack, embalaje, IsEscaneado) " +
        ...
        public static string GetSqlWmsInsertItemInventario(ItemInventario Ii) {
            return $"INSERT INTO {DBName}.dbo.ItemInventario(ItemInventarioID, InventarioID, CodProducto, Declarado, Precio, Observacion, fechaitem, descripcion, auditado, existencia, CantidadInicial, cod_equivale, pais_orig, lote, numero_oc, modelo, color, estilo) " +
        ...
        public static string GetSqlWmsInsertDtllItemTransaccion(DtllItemTransaccion Dit) {
            return $"INSERT INTO {DBName}.dbo.DtllItemTransaccion(DtllItemTransaccionID, TransaccionID, DtllTransaccionID, ItemInventarioID, Cantidad, Precio, RACK) " +
        ...
        public static string GetSqlWmsInsertItemParamaetroxProducto(ItemParamaetroxProducto Pa) {
            return $"INSERT INTO {DBName}.dbo.ItemParamaetroxProducto(InventarioID, ItemInventarioID, CodProducto, ParametroID, ValParametro) " +
        ...
        public static string GetSqlWmsUpdateTransaccionesRackFull() {
            return $"UPDATE {DBName}.dbo.Transacciones SET EstatusId = 6 WHERE TransaccionID = @MaxTransaccionId; {Temp}";
        }

        public static string GetSqlWmsInsertDocumentosxTransaccion(DocumentosxTransaccion D) {
            return $"INSERT INTO {DBName}.dbo.DocumentosxTransaccion(IDDocxTransaccion, transaccionid, fecha, INFORME_ALMACEN, FE_INFORME_ALMACEN, IM_5, fe_im_5, ORDEN_COMPRA) " +
